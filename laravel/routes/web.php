...
Route::get('/meeting-management/count_reload/{id}', [MeetingManagementController::class, 'countReload'])->name('presentation_meeting_management_count_reload')->middleware('auth');
